...
public class TileLvTurbine extends TileEntity implements IWrenchable, IEnergyTile{
	...
	{
		energy = new BasicSource(this, 10000, 1);
	}
	...
	{
		return new ItemStack(ModBlocks.LvWaterTurbine);
	}
