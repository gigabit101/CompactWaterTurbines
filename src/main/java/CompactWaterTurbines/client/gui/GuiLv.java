...
public class GuiLv extends GuiContainer{
	...
	TileLvTurbine tilelv;
	ContainerLv container;
	
	public GuiLv(EntityPlayer player, TileLvTurbine tile) 
	{
		super(new ContainerLv(tile, player));
		this.container = (ContainerLv) inventorySlots;
		this.xSize = 176;
		this.ySize = 167;
		tilelv = tile;
	}
	...
	{
		String name = StatCollector.translateToLocal("tile.CompactWaterTurbines.lvwaterturbine.name");
